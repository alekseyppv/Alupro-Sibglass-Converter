...
pyinstaller --noconfirm --onefile --windowed --name SibglassConverter --hidden-import sibglass_app.controllers.main_controller --hidden-import sibglass_app.services.sibglass_writer sibglass_app/main.py
```
